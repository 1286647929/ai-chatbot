...
export const myProvider = isTestEnvironment
  ...
  : customProvider({
      languageModels: {
        ...
        "chat-model": newapi.chat("openai/gpt-4.1-mini"),
        "chat-model-reasoning": wrapLanguageModel({
          model: newapi.chat("openai/gpt-4.1-mini"),
          middleware: extractReasoningMiddleware({ tagName: "think" }),
        }),
        "title-model": newapi.chat("openai/gpt-4.1-mini"),
        "artifact-model": newapi.chat("openai/gpt-4.1-mini"),
        // 法律多 Agent 系统模型配置
        "intent-model": newapi.chat("openai/gpt-4.1-mini"), // 意图识别 - 快速、低成本
